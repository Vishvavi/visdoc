...
const PatientDetails = ({navigation,route}) => {
 ...
 useDimensionsChange(
  ...
  const ToCalendar = () =>{
   ...
   else if(((patient!=false)&&(ReasonForReferral!=false)&&(specialty!=false)&&(VisitTypeId==="1002"))){
...
<View style={{padding:responsiveWidth(2)}}>
    <View style={{backgroundColor: 'transparent',marginTop: 60, padding: 20,height:70, borderRadius: 15}}>
        ...
        />
            ...
            <View style={{backgroundColor: 'transparent',marginTop:10, padding: 20,height:70,}}>
...
{specialty!=1006 &&(
<View style={{backgroundColor: 'transparent',marginTop:10, padding: 20,height:70, borderRadius: 15}}>
            {renderProviderLabel()}
            <Dropdown
              style={[styles.dropdown]}
              placeholderStyle={styles.placeholderStyle}
