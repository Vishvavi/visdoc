import { FlatList, StyleSheet, Text, TouchableOpacity, View ,StatusBar,Image,AccessibilityActionEvent,Alert} from 'react-native'
...
const Reschedule = ({ navigation,route }) => {
    const{ID,item,VisitTypeId,Scribe,Detailflow}=route.params;
    ...
    console.log(ID)
      console.log(Scribe)
        console.log(item.SpecialtyTypeId)
      },[])
  ...
  Popup.show({
    ...
    const ToProvider = () => {
            ...
            if((selectDate1!=false)&&(selectedDate===null)){
                ...
                navigation.navigate('RescheduleProvider',{ID,AssignedDate,Detailflow,AssignedTime,item,VisitTypeId,Scribe})
                 // setselectDate1(false)   
                  ...
                  //  setselectDate1(false)   
                    ...
                    navigation.navigate('RescheduleProvider',{ID,AssignedDate,Detailflow,AssignedTime,Scribe,item,VisitTypeId})
                }
                ...
                else if((AssignedDate!=null)&&(Hour==null)||(Minutes==null))
                {
